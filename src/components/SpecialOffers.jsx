...
const offers = [
    {
        ...
        description: "Միացի՛ր All in կամ Wi-fly փաթեթներին, ստացի՛ր մինչև 40 000 դրամ նվեր բաժանորդային հաշվիդ",
        buttons: ["learn"]
    },
    {
        image: Img2,
                ...
                <div className="special-offers-wrapper">
                    ...
                    <div className="special-offers-container">
                        <div className="special-offers-inner"
                            style={{
                                transform: `translateX(-${currentIndex * (CARD_WIDTH + CARD_MARGIN_RIGHT)
                                    }px)`,
                            }}
                        >
                            {offers.map(({image,title,description,buttons})=>{
